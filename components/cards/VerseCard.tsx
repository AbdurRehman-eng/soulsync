  ...
  return (
    <>
      <div className="min-h-full flex flex-col overflow-hidden">
        ...
        {/* Verse content — vertically centered; reference at bottom */}
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div className="flex-1 min-h-0" aria-hidden />
          {/* Reference - always visible at bottom */}
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.4 }}
            className="text-sm sm:text-base text-accent font-medium flex-shrink-0"
          >
            — {verse_reference}
          </motion.p>
        </div>
